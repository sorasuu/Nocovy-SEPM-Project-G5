...
export default function ProductDialogTable(props) {
    ...
    console.log('check lai products', products)
                                ...
                                .map((product, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="right"><img style={{ width: '75px', height: '100px' }} src={product.cover} /></TableCell>
                                            <TableCell align="right">{product.price.unitPrice}</TableCell>
